!function (n) {
    ...
    N = function () {
        var n, t, i;
        return t = e.navigator.userAgent,
        (n = /(?=.+Mac OS X)(?=.+Firefox)/.test(t)) ? (i = /Firefox\/\d{2}\./.exec(t),
        i && (i = i[0].replace(/\D+/g, "")),
        n && +i > 23) : !1
    }
    ,
    v = function () {
        function c(i, a) {
            ...
            s || (s = _()),
            this.$el = n(this.el),
            this.doc = n(this.options.documentContext || t),
            this.win = n(this.options.windowContext || e),
        ...
        return c.prototype.preventScrolling = function (n, e) {
            if (this.isActive)
                if (n.type === a)
                    (e === o && n.originalEvent.detail > 0 || e === x && n.originalEvent.detail < 0) && n.preventDefault();
                else if (n.type === p) {
                    if (!n.originalEvent || !n.originalEvent.wheelDelta)
                        return;
        ...
        c.prototype.updateScrollValues = function () {
            var n, e;
            n = this.content,
            this.maxScrollTop = n.scrollHeight - n.clientHeight,
            this.prevScrollTop = this.contentScrollTop || 0,
            this.contentScrollTop = n.scrollTop,
        ...
        c.prototype.setOnScrollStyles = function () {
            var n;
            I ? (n = {},
            n[H] = "translate(0, " + this.sliderTop + "px)") : n = {
                top: this.sliderTop
            },
            k ? (w && this.scrollRAF && w(this.scrollRAF),
            this.scrollRAF = k(function (e) {
                return function () {
        ...
        c.prototype.createEvents = function () {
            this.events = {
                down: function (n) {
                    return function (e) {
                        return n.isBeingDragged = !0,
                        n.offsetY = e.pageY - n.slider.offset().top,
                        n.slider.is(e.target) || (n.offsetY = 0),
                        n.pane.addClass("active"),
                        n.doc.bind(h, n.events[r]).bind(g, n.events[x]),
                        n.body.bind(u, n.events[l]),
                        !1
                    }
                }(this),
                drag: function (n) {
                    return function (e) {
                        return n.sliderY = e.pageY - n.$el.offset().top - n.paneTop - (n.offsetY || .5 * n.sliderHeight),
                        n.scroll(),
                        n.contentScrollTop >= n.maxScrollTop && n.prevScrollTop !== n.maxScrollTop ? n.$el.trigger("scrollend") : 0 === n.contentScrollTop && 0 !== n.prevScrollTop && n.$el.trigger("scrolltop"),
                        !1
                    }
                }(this),
                up: function (n) {
                    return function () {
                        return n.isBeingDragged = !1,
                        n.pane.removeClass("active"),
                        n.doc.unbind(h, n.events[r]).unbind(g, n.events[x]),
                        n.body.unbind(u, n.events[l]),
                        !1
                    }
                }(this),
                resize: function (n) {
                ...
                panedown: function (n) {
                    return function (e) {
                        return n.sliderY = (e.offsetY || e.originalEvent.layerY) - .5 * n.sliderHeight,
                        n.scroll(),
                        n.events.down(e),
                        !1
                    }
                ...
                scroll: function (n) {
                    return function (e) {
                        n.updateScrollValues(),
                        n.isBeingDragged || (n.iOSNativeScrolling || (n.sliderY = n.sliderTop,
                        n.setOnScrollStyles()),
                        null != e && (n.contentScrollTop >= n.maxScrollTop ? (n.options.preventPageScrolling && n.preventScrolling(e, o),
                        n.prevScrollTop !== n.maxScrollTop && n.$el.trigger("scrollend")) : 0 === n.contentScrollTop && (n.options.preventPageScrolling && n.preventScrolling(e, x),
                        0 !== n.prevScrollTop && n.$el.trigger("scrolltop"))))
                    }
                }(this),
                wheel: function (n) {
                    return function (e) {
                        var t;
                        return null != e ? (t = e.delta || e.wheelDelta || e.originalEvent && e.originalEvent.wheelDelta || -e.detail || e.originalEvent && -e.originalEvent.detail,
                        t && (n.sliderY += -t / 3),
                        n.scroll(),
                        !1) : void 0
                    }
        ...
        c.prototype.addEvents = function () {
            ...
            this.removeEvents(),
            n = this.events,
            this.options.disableResize || this.win.bind(y, n[y]),
            this.iOSNativeScrolling || (this.slider.bind(d, n[o]),
            this.pane.bind(d, n[m]).bind("" + p + " " + a, n[S])),
            this.$content.bind("" + C + " " + p + " " + a + " " + T, n[C])
        }
        ,
        c.prototype.removeEvents = function () {
            var n;
            n = this.events,
            this.win.unbind(y, n[y]),
            this.iOSNativeScrolling || (this.slider.unbind(),
            this.pane.unbind()),
            this.$content.unbind("" + C + " " + p + " " + a + " " + T, n[C])
        }
        ,
        c.prototype.generate = function () {
            ...
            l = a.sliderClass,
            n = a.contentClass,
            (o = this.$el.children("." + r)).length || o.children("." + l).length || this.$el.append('<div class="' + r + '"><div class="' + l + '" /></div>'),
            this.pane = this.$el.children("." + r),
            this.slider = this.pane.find("." + l),
            0 === s && N() ? (i = e.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/[^0-9.]+/g, ""),
            t = {
                right: -14,
                paddingRight: +i + 14
            }) : s && (t = {
        ...
        c.prototype.reset = function () {
            ...
            d > 0 && (this.$el.height(""),
            this.$el.height(n.scrollHeight > d ? d : n.scrollHeight)),
            l = this.pane.outerHeight(!1),
            f = parseInt(this.pane.css("top"), 10),
            r = parseInt(this.pane.css("bottom"), 10),
            c = l + f + r,
            h = Math.round(c / e * l),
            ...
            this.pane.show(),
            this.isActive = !0,
            n.scrollHeight === n.clientHeight || this.pane.outerHeight(!0) >= n.scrollHeight && o !== C ? (this.pane.hide(),
            this.isActive = !1) : this.el.clientHeight === n.scrollHeight && o === C ? this.slider.hide() : this.slider.show(),
            this.pane.css({
        ...
        c.prototype.scrollBottom = function (n) {
            return this.isActive ? (this.$content.scrollTop(this.contentHeight - this.$content.height() - n).trigger(p),
            this.stop().restore(),
            this) : void 0
        }
        ,
        c.prototype.scrollTop = function (n) {
            return this.isActive ? (this.$content.scrollTop(+n).trigger(p),
            this.stop().restore(),
            this) : void 0
        }
        ,
        c.prototype.scrollTo = function (n) {
            return this.isActive ? (this.scrollTop(this.$el.find(n).get(0).offsetTop),
            this) : void 0
        }
        ,
    ...
    n.fn.nanoScroller = function (e) {
        return this.each(function () {
            var t, i;
            if ((i = this.nanoscroller) || (t = n.extend({}, E, e),
            this.nanoscroller = i = new v(this, t)),
            e && "object" == typeof e) {
                if (n.extend(i.options, e),
                null != e.scrollBottom)
                ...
                if (e.scroll && e.scroll instanceof n)
...
!function (n, e) {
    ...
    : function (n) {
      ...
      , s = function (n) {
          ...
          function s() {
              a = t(),
              n.fn.emulateTransitionEnd = i,
              r.supportsTransitionEnd() && (n.event.special[r.TRANSITION_END] = e())
          }
          var a = !1
            , o = {
    ...
    !function (n) {
        var e = "metisMenu"
          ...
          , u = function () {
              ...
              return e.prototype.init = function () {
                  ...
                  n(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(d.CLICK_DATA_API, function (t) {
                      var i = n(this)
                      ...
                      e._config.preventDefault && t.preventDefault(),
                      "true" !== i.attr("aria-disabled") && (s.hasClass(e._config.activeClass) ? (i.attr("aria-expanded", !1),
                      e._hide(o)) : (e._show(o),
                      i.attr("aria-expanded", !0),
                      e._config.toggle && a.attr("aria-expanded", !1)),
                      e._config.onTransitionStart && e._config.onTransitionStart(t))
                  })
              }
              ,
              ...
              e._jQueryInterface = function (t) {
                  return this.each(function () {
                      ...
                      if (!o && /dispose/.test(t) && this.dispose(),
                      o || (o = new e(this, r),
                      s.data(a, o)),
                      "string" == typeof t) {
                          if (void 0 === o[t])
        ...
        return n.fn[e] = u._jQueryInterface,
        n.fn[e].Constructor = u,
...
!function (n) {
    ...
    n(document).on("nifty.ready", function () {
        e = n(".mega-dropdown"),
        e.length && (e.niftyMega(),
        n("html").on("click", function (t) {
        ...
        if (e.length && !i) {
            var s = !1
              ...
              , o = function () {
                  ...
                  s = !0) : t.scrollTop() < a && s && (e.removeClass("in"),
                  s = !1)
              };
            o(),
            t.scroll(o),
...
!function (n) {
    ...
    var e = {
      ...
      , i = {
          show: function (e) {
              var i = n(e.attr("data-target"))
                , s = "nifty-overlay-" + t() + t() + "-" + t()
                , a = n('<div id="' + s + '" class="panel-overlay"></div>');
              return e.prop("disabled", !0).data("niftyOverlay", s),
              i.addClass("panel-overlay-wrap"),
              a.appendTo(i).html(e.data("overlayTemplate")),
              null
          },
          hide: function (e) {
              var t = n(e.attr("data-target"))
                , i = n("#" + e.data("niftyOverlay"));
              return i.length && (e.prop("disabled", !1),
      ...
      , s = function (t, i) {
          ...
          return t.data("overlayTemplate", '<div class="panel-overlay-content pad-all unselectable">' + a + '<h4 class="panel-overlay-title">' + s.title + "</h4><p>" + s.desc + "</p></div>"),
          null
      };
    n.fn.niftyOverlay = function (e) {
    ...
    n.niftyNoty = function (l) {
        {
            var h, c = {
                ...
                onHide: function () { },
                onHidden: function () { }
            }, f = n.extend({}, c, l), d = n('<div class="alert-wrap"></div>'), u = function () {
                var n = "";
                return l && l.icon && (n = '<div class="media-left alert-icon"><i class="' + f.icon + '"></i></div>'),
                n
            }, g = function () {
                ...
                r || (f.onHidden(),
                d.remove())),
                d.removeClass("in").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function (n) {
                    "max-height" == n.originalEvent.propertyName && (f.onHidden(),
                    d.remove())
                }),
                clearInterval(h),
                null
            ...
            !function () {
                if (f.onShow(),
                "page" === f.container)
                    e || (e = n('<div id="page-alert"></div>'),
                    a && a.length || (a = n("#content-container")),
                    a.prepend(e)),
                    i = e,
                    f.focus && v(0);
                else if ("floating" === f.container)
                    t[f.floating.position] || (t[f.floating.position] = n('<div id="floating-' + f.floating.position + '" class="floating-container"></div>'),
                    s && a.length || (s = n("#container")),
                    s.append(t[f.floating.position])),
                    ...
                    if (!r.length)
                        return o = !1,
                        !1;
                    l.length ? i = l : (i = n('<div class="panel-alert"></div>'),
                    c.length ? c.after(i) : r.prepend(i)),
                    f.focus && v(r.offset().top - 30)
                }
                return o = !0,
                !1
            }()
        ...
        if (o) {
            if (i.append(d.html(g)),
            d.find('[data-dismiss="noty"]').one("click", p),
            f.closeBtn && d.find(".close").one("click", p),
            f.timer > 0 && (h = setInterval(p, f.timer)),
            !f.focus)
            ...
            d.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function (n) {
                "max-height" != n.originalEvent.propertyName && "animationend" != n.type || !o || (f.onShown(),
                o = !1)
            })
        }
    }
    ...
    var e = {
      ...
      , t = function (t, i) {
          ...
          r.on("click", function (e) {
              s.dynamicMode && (e.preventDefault(),
              e.stopPropagation()),
              t.dropdown("toggle"),
              f(n(this))
          }),
      ...
      , i = {
          ...
          setDisable: function () {
              return n(this).addClass("disabled"),
              null
          },
          setEnable: function () {
              return n(this).removeClass("disabled"),
              null
          }
      };
    n.fn.niftyLanguage = function (e) {
        var s = !1;
        return this.each(function () {
...
!function (n) {
    "use strict";
    var e, t = function (e) {
        if (!e.data("nifty-check")) {
            e.data("nifty-check", !0),
            e.text().trim().length ? e.addClass("form-text") : e.removeClass("form-text");
            var t = e.find("input")[0]
              ...
              , a = function () {
                  "radio" == t.type && s.length && s.each(function () {
                      var e = n(this);
                      e.hasClass("active") && e.trigger("nifty.ch.unchecked"),
                      e.removeClass("active")
                  }),
                  t.checked ? e.addClass("active").trigger("nifty.ch.checked") : e.removeClass("active").trigger("nifty.ch.unchecked")
              };
            t.checked ? e.addClass("active") : e.removeClass("active"),
            n(t).on("change", a)
        }
    }, i = {
        isChecked: function () {
        ...
        e = n(".form-checkbox, .form-radio"),
        e.length && e.niftyCheck()
    };
    n.fn.niftyCheck = function (e) {
        var s = !1;
        return this.each(function () {
            i[e] ? s = i[e].apply(n(this).find("input"), Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e || t(n(this))
        }),
    ...
    ,
    n(document).on("nifty.ready", s).on("change", ".form-checkbox, .form-radio", s).on("change", ".btn-file :file", function () {
        var e = n(this)
...
!function (n, e) {
    ...
    t.poll = function () {
        ...
        s.timeoutId && e.clearTimeout(s.timeoutId),
        s.timeoutId = e.setTimeout(function () {
...
!function (n) {
    ...
    var e = null
      ...
      , g = function () {
          ...
          i.each(function () {
              ...
              a.popover({
                  ...
                  content: function () {
                      var e;
                      return y ? (e = n('<div class="sub-menu"></div>'),
                      r.addClass("pop-in").wrap('<div class="nano-content"></div>').parent().appendTo(e)) : l.length ? (e = n('<div class="sidebar-widget-popover"></div>'),
                      l.wrap('<div class="nano-content"></div>').parent().appendTo(e)) : e = '<span class="single-content">' + o.html() + "</span>",
                      e
                  },
                  template: '<div class="popover menu-popover"><h4 class="popover-title"></h4><div class="popover-content"></div></div>'
              }).on("show.bs.popover", function () {
                  if (!f) {
                      if (f = a.data("bs.popover").tip(),
                  ...
                  i > r ? (d.length && !d.is(":visible") && (o = Math.round(0 - .5 * o)),
                  i -= 5,
                  u.css({
                      top: "",
                      bottom: o + "px",
                  ...
                  b(u.find(".nano"))) : (!t.hasClass("navbar-fixed") && s.hasClass("affix-top") && (r -= 50),
                  c > r ? ((t.hasClass("navbar-fixed") || s.hasClass("affix-top")) && (r -= o + 5),
                  r -= 5,
                  u.css({
                      top: o + "px",
                      bottom: "",
                  ...
                  d.length && d.css("height", a.outerHeight()),
                  u.on("click", function () {
                  ...
                  a.addClass("hover").popover("show"))
              }).hover(function () {
                  i.popover("hide"),
                  a.addClass("hover").popover("show").one("hidden.bs.popover", function () {
                      a.removeClass("hover"),
                      y ? r.removeAttr("style").appendTo(a.parent()) : l.length && l.appendTo(c),
                      clearInterval(e)
                  })
              }, function () {
                  clearInterval(e),
                  e = setInterval(function () {
                      ...
                      f.is(":hover") || a.removeClass("hover").popover("hide")),
                      clearInterval(e)
                  }, 100)
              })
          }),
      ...
      , p = function () {
          ...
          e.popover("destroy").unbind("mouseenter mouseleave"),
          l = !1
      }
      , v = function () {
          var i, e = t.width();
          i = 740 >= e ? "xs" : e > 740 && 992 > e ? "sm" : e >= 992 && 1200 >= e ? "md" : "lg",
          f != i && (f = i,
          c = i,
          "sm" == c && t.hasClass("mainnav-lg") ? (t.addClass("lg-mainnav-lg"),
          n.niftyNav("collapse")) : "xs" == c && t.hasClass("mainnav-lg") ? t.removeClass("mainnav-sm mainnav-out mainnav-lg").addClass("mainnav-sm lg-mainnav-lg") : "md" != c && "lg" != c || !t.hasClass("lg-mainnav-lg") || (t.removeClass("lg-mainnav-lg"),
          n.niftyNav("expand")))
      }
      , m = function () {
      ...
      , C = function () {
          ...
          v(),
          m(),
          ("collapse" == r || t.hasClass("mainnav-sm")) && (t.removeClass("mainnav-in mainnav-out mainnav-lg"),
          g()),
          a = n("#mainnav").height(),
          r = !1,
          null
      ...
      , T = {
          ...
          bind: function () {
              ...
              if (0 == r.length)
                  return !1;
              e = n('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]'),
              t = n("#container"),
              i = t.children(".boxed"),
              s = n("#mainnav-container"),
              a = n("#mainnav").height();
              var l = null;
              s.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function (e) {
                  (l || e.target === s[0]) && (clearInterval(l),
              ...
              c.length && c.on("click", function (e) {
                  e.preventDefault(),
                  e.stopPropagation(),
                  n.niftyNav(c.hasClass("push") ? "pushToggle" : c.hasClass("slide") ? "slideToggle" : c.hasClass("reveal") ? "revealToggle" : "colExpToggle")
              });
              try {
                  r.metisMenu({
                      toggle: !0
    ...
    n.fn.isOnScreen = function () {
        ...
        n.right = n.left + u.width(),
        n.bottom = n.top + u.height();
        var e = this.offset();
        return e.right = e.left + this.outerWidth(),
        e.bottom = e.top + this.outerHeight(),
        !(n.right < e.left || n.left > e.right || n.bottom < e.bottom || n.top > e.top)
    }
}(jQuery),
!function (n) {
    "use strict";
    var t, e = null, i = n(window), s = {
        toggleHideShow: function () {
            t.toggleClass("aside-in"),
            i.trigger("resize"),
            t.hasClass("aside-in") && a()
        },
        show: function () {
            t.addClass("aside-in"),
            i.trigger("resize"),
        ...
        var e = t.width();
        t.hasClass("mainnav-in") && e > 740 && (e > 740 && 992 > e ? n.niftyNav("collapse") : t.removeClass("mainnav-in mainnav-lg mainnav-sm").addClass("mainnav-out"))
    }, o = n("#container").children(".boxed"), c = function () {
        try {
            e.niftyAffix("update")
        } catch (n) { }
        var i = {};
        ...
        if (e = n("#aside-container"),
        e.length) {
            t = n("#container"),
            i.on("resizeEnd", c),
            e.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function (n) {
    ...
    n.niftyAside = function (n, e) {
        return s[n] && (s[n].apply(this, Array.prototype.slice.call(arguments, 1)),
        e) ? e() : null
    }
}(jQuery),
!function (n) {
    ...
    var e, t, i, s, a, o, r = function (n) {
        ...
        i = n("#container"),
        e = n("#mainnav-container"),
        t = n("#aside-container"),
        s = n("#mainnav-menu-wrap > .nano"),
        a = n("#aside > .nano"),
    ...
    n.fn.niftyAffix = function (e) {
        return this.each(function () {
            var s, t = n(this);
            "object" != typeof e && e ? "update" == e ? (t.data("nifty.af.class") || l(),
            s = t.data("nifty.af.class"),
            r(t)) : "bind" == e && l() : (s = e.className,
            t.data("nifty.af.class", e.className)),
            i.hasClass(s) && !i.hasClass("navbar-fixed") ? t.affix({
                offset: {
                    top: n("#navbar").outerHeight()
                }
            }).on("affixed.bs.affix affix.bs.affix", function () {
                r(t)
            }) : (!i.hasClass(s) || i.hasClass("navbar-fixed")) && (n(window).off(t.attr("id") + ".affix"),
