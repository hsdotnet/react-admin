...
$(function () {
    ...
    }).html('Ready to sell your theme? Submit your theme to our new marketplace now and let over 200k visitors see it!').css(link_css).hover(function () {
